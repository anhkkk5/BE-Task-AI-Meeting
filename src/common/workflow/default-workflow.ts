...
export const DEFAULT_WORKFLOW_TRANSITIONS: WorkflowTransitionConfig[] = [
  ...
  { from: TaskStatus.InProgress, to: TaskStatus.Todo },
  { from: TaskStatus.InProgress, to: TaskStatus.Review },
  { from: TaskStatus.Review, to: TaskStatus.InProgress },
  { from: TaskStatus.Review, to: TaskStatus.Done },
  { from: TaskStatus.Done, to: TaskStatus.InProgress },
];
