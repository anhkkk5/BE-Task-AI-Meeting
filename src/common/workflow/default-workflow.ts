...
export type WorkflowStatusConfig = { workflowStatusId?: string; key: TaskStatus; label: string; color: string; category: 'TO_DO' | 'IN_PROGRESS' | 'DONE'; order: number; enabled: boolean };
