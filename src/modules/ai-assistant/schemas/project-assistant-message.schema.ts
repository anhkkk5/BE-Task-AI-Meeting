...
export class ProjectAssistantMessage {
  ...
  @Prop({ type: Object, default: null }) actionDraft?: Record<string, unknown> | null;
}

export const ProjectAssistantMessageSchema = SchemaFactory.createForClass(ProjectAssistantMessage);
