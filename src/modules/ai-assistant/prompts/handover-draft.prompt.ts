/**
 * Prompt cho tinh nang "AI soan noi dung ban giao".
 *
 * Dau ra khop dung cac o cua form ban giao de nguoi dung chi phai soat lai roi
 * gui, thay vi tu viet tu dau. Diem quan trong: AI khong duoc bia phan viec con
 * lai, vi nguoi nhan se dua vao do de lam tiep.
 */
export const HANDOVER_DRAFT_PROMPT_TEMPLATE = `
