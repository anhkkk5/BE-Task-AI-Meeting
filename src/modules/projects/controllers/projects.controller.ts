...
export class ProjectsController {
  ...
  createWorkflowTemplate(
    ...
    return this.projectsService.createWorkflowTemplate(
      user.id,
      workspaceId,
      dto,
    );
  ...
  updateWorkflowTemplate(
    ...
    return this.projectsService.updateWorkflowTemplate(
      user.id,
      workspaceId,
      templateId,
      dto,
  ...
  deleteWorkflowTemplate(
    ...
    return this.projectsService.deleteWorkflowTemplate(
      user.id,
      workspaceId,
      templateId,
    );
  ...
  @Patch(':projectId/workflow-template/:templateId')
  @WorkspaceRoles(...projectWriteRoles)
  @UseGuards(WorkspaceRolesGuard)
  applyWorkflowTemplate(
    ...
    return this.projectsService.applyWorkflowTemplate(
      user.id,
      workspaceId,
      projectId,
      templateId,
