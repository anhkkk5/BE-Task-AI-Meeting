...
export class SaveAutomationRuleDto {
  ...
  @IsArray() conditions: Array<{ field: string; operator: string; value?: unknown }>;
  @IsArray() actions: Array<{ type: 'NOTIFY_ASSIGNEE' | 'CHANGE_STATUS' | 'ASSIGN_USER'; value?: string; message?: string }>;
}
