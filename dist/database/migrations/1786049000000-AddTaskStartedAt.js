...
class AddTaskStartedAt1786049000000 {
    ...
    async up(queryRunner) { await queryRunner.query('ALTER TABLE `tasks` ADD `started_at` datetime NULL'); }
    async down(queryRunner) { await queryRunner.query('ALTER TABLE `tasks` DROP COLUMN `started_at`'); }
}
