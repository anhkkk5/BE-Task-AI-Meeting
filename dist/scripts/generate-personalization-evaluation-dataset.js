...
function main() {
    const outputPath = (0, node_path_1.resolve)(process.env.PERSONALIZATION_EVAL_DATASET_PATH ??
        (0, node_path_1.join)('datasets', 'personalization-evaluation', 'v1', 'cases.jsonl'));
    const records = Array.from({ length: 36 }, (_, index) => {
        ...
        const question = feature === 'PERSONALIZED_QA'
        ...
        return {
            ...
            groundTruth: {
                ...
                expectedDifferenceFromPair: 'Nội dung phải khác người còn lại về nhiệm vụ, rủi ro và trọng tâm.',
...
main();
//# sourceMappingURL=generate-personalization-evaluation-dataset.js.map