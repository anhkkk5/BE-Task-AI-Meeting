...
function verifyAnswer(c, answer, suggestedQuestions, sources) {
    let isCorrect = false;
...
async function main() {
    ...
    (0, node_fs_1.mkdirSync)((0, node_path_1.dirname)(rawResponsesPath), { recursive: true });
    (0, node_fs_1.writeFileSync)(rawResponsesPath, '', 'utf8');
    ...
    for (let i = 0; i < cases.length; i++) {
        ...
        try {
            ...
            (0, node_fs_1.appendFileSync)(rawResponsesPath, JSON.stringify(logRecord) + '\n', 'utf8');
...
//# sourceMappingURL=run-project-assistant-openai-live.js.map