...
let AutomationScheduler = class AutomationScheduler {
    ...
    async run() { for (const rule of await this.repo.enabledRules())
...
exports.AutomationScheduler = AutomationScheduler = __decorate([
    ...
    __metadata("design:paramtypes", [automation_repository_1.AutomationRepository, automation_service_1.AutomationService])
], AutomationScheduler);
