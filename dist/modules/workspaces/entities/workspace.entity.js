...
const workspace_plan_enum_1 = require("../../../common/enums/workspace-plan.enum");
...
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.Column)({ name: 'owner_id', type: 'varchar', length: 36 }),
    __metadata("design:type", String)
], Workspace.prototype, "ownerId", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: workspace_plan_enum_1.WorkspacePlan,
        default: workspace_plan_enum_1.WorkspacePlan.Free,
    }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({
        ...
        default: workspace_status_enum_1.WorkspaceStatus.Active,
    }),
    __metadata("design:type", String)
